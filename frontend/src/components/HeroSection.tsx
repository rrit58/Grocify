  ...
  return (
    <section className='relative overflow-hidden'>
      <div className='bg-primary/5 grid lg:grid-cols-2 gap-10 items-center container mx-auto px-4 lg:px-8 py-8 lg:py-10'>
        {/* Content */}
        <div>
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-green-800 text-xs font-semibold mb-6">
            <Leaf className="w-3.5 h-3.5" /> Fresh & Organic
          </span>
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
            Fresh Groceries,{" "}
            <span className="text-green-800">Delivered</span> to Your Door
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mb-10">
            <Button asChild size="lg" className="bg-green-800 text-primary-foreground hover:bg-primary/90 rounded-full px-8 font-semibold gap-2">
          ...
          <div className="flex flex-wrap gap-6">
            {[
              ...
              <div key={text} className="flex items-center gap-2 text-md text-green-800">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-card">
          ...
          <div className="absolute bottom-4 left-4 bg-card/90 backdrop-blur-sm rounded-2xl p-4 shadow-card">
            <p className="text-xs text-orange-600">Today's offer</p>
            <p className="font-display font-bold text-foreground text-lg">Up to 40% Off</p>
            <p className="text-xs text-green-800 font-semibold">on fresh vegetables</p>
          </div>
        </div>
      </div>
    </section>
